...
if (!requireNamespace("ggplot2", quietly = TRUE)) {
  install.packages("ggplot2", lib = "/home1/mose1103/R/library")
}
...
cov1 <- matrix(c(1.5, 0.2, 0.4, 1.5), nrow = 2)
cov2 <- matrix(c(1.5, 0.1, -0.4, 1.5), nrow = 2)
cov3 <- matrix(c(1.5, 0.5, -0.3, 1.5), nrow = 2)
...
N <- 1000  # Set this to your desired number of iterations
...
for (i in 1:N) {
  output <- try(m1, m2, itrN = 100, K = 3, k_near = 10)
