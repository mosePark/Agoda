...
plot(raw_dat2, xlab='', ylab='', cex=5, xaxt='n', yaxt='n', ylim = c(-6,6), xlim=c(-6,6), cex.lab = label_size, font.lab = label_font, col="white")
...
plot(raw_dat1, cex=5, xlab='', ylab='', xaxt='n', yaxt='n', xlim = c(-6,6), ylim =c(-6, 6), cex.lab = label_size, font.lab = label_font, col=yarrr::transparent("darkgrey", trans.val = 0.5), bg=yarrr::transparent("darkgrey", trans.val = 0.5), pch=16)
...
plot(raw_dat3, xlab ='', ylab = '',cex=5 , xlim=c(-6, 6), ylim=c(-6, 6), xaxt='n', yaxt='n', cex.lab = label_size, font.lab = label_font, col="white")
...
plot(raw_dat1, cex=5,xlab='', ylab='', xaxt='n', yaxt='n', xlim = c(-6,6), ylim = c(-6,6), cex.lab = label_size, font.lab = label_font, col="white")
...
# 1 by 3 (new)
par(fig = c(0.66, 1, 0.5, 1), new = TRUE)
plot(raw_dat3_new, cex=5,xlab='', ylab='', xaxt='n', yaxt='n', xlim = c(-6, 6), ylim = c(-6, 6), cex.lab = label_size, font.lab = label_font, col="white")
